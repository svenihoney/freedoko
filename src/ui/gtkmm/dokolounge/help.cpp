...
namespace UI_GTKMM_NS {
  namespace DokoLounge {
    ...
    /**
     ** show the help and update the text
     **
     ...
     **/
    void
      Help::update_text(string const& text)
      {
        this->text->get_buffer()->set_text(text);
        return;
      } // void Help::update_text(string text)
